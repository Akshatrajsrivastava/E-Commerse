...
export default function Banners() {
    ...
    const handleBannerUploadSuccess = (bannerType: 'main' | 'secondary1' | 'secondary2') => {
    ...
    return (
        <div className="w-full max-w-[2000px] mx-auto p-4 space-y-6 bg-[#fafaff]">
            ...
            <div className="relative w-full aspect-[21/9] rounded-2xl overflow-hidden group shadow-lg">
                ...
                <div className="absolute bottom-4 right-4 z-10 bg-[#2E3B69] text-white p-3 rounded-lg">
                    <BannerUpload
                        bannerType="main"
                        onUploadSuccess={handleBannerUploadSuccess('main')}
                    />
                </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <div className="relative aspect-[16/7] rounded-xl overflow-hidden group shadow-md">
                    ...
                    <div className="absolute bottom-4 right-4 z-10 bg-[#2E3B69] text-white p-3 rounded-lg">
                        <BannerUpload
                            bannerType="secondary1"
                            onUploadSuccess={handleBannerUploadSuccess('secondary1')}
                        />
                    </div>
                </div>
                ...
                <div className="relative aspect-[16/7] rounded-xl overflow-hidden group shadow-md">
                    ...
                    <div className="absolute bottom-4 right-4 z-10 bg-[#2E3B69] text-white p-3 rounded-lg">
                        <BannerUpload
                            bannerType="secondary2"
                            onUploadSuccess={handleBannerUploadSuccess('secondary2')}
                        />
                    </div>
                </div>
            </div>
